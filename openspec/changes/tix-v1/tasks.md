...
- [ ] 7.1 WP-50 `internal/capability`: operation registry covering every Service method
- [ ] 7.2 WP-50 Parity test: every Service method appears in the registry
- [ ] 7.3 WP-50 Parity test: every operation has CLI, HTTP, and Web bindings, or a justified exemption
- [ ] 7.4 WP-50 Parity test: every binding resolves against the real mux, command tree, and templates
- [ ] 7.5 WP-51 `docs/`: agents, workflows, configuration, tenancy, api, scripting, deployment, scaling, migrating, shell-completion
- [ ] 7.6 WP-51 `docs/README.md` index and the link check
- [ ] 7.7 WP-51 README command table generated by `tix docs`
- [ ] 7.8 WP-52 `internal/bench`: seeded fixture and benchmarks with p95 budgets
- [ ] 7.9 WP-52 Cross-transport integration test: direct-database write observed over WebSocket and webhook
